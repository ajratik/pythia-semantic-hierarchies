...
Ноутбуки к дипломной работе:    
Анализ иерархий семантических категорий во внутренних представлениях больших языковых моделей.
...
├── 02_exps_1_3_4.ipynb       # Эксперименты 1, 3, 4: RSA, асимметрия, ортогональность
├── 03_exp_2.ipynb             # Эксперимент 2: динамика обучения
...
### 02 — Эксперименты 1, 3, 4: RSA, асимметрия иерархии, ортогональность направлений
...
**Эксперимент 3 — Асимметрия иерархии.**
...
**Эксперимент 4 — Ортогональность направлений.**
...
### 03 — Эксперимент 2: динамика обучения, фазовый переход
